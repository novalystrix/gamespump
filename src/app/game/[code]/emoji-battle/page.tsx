  ...
  return (
    <div className="animate-slide-up text-center">
      ...
      <div className="space-y-3">
        <ShareResults gameName="Emoji Battle" winnerName={sorted[0]?.name ?? ''} winnerScore={gameState.scores[sorted[0]?.id] || 0} />
        {isHost ? (
          <>
            <button
          ...
          <>
            ...
            {gameState.phase === 'playing' && (
              <div className="text-center mb-6 py-5 glass rounded-2xl">
                <p className="text-white/50 text-xs uppercase tracking-widest mb-2 font-semibold">Find this emoji!</p>
